...
public class VideoAdapter extends CardScrollAdapter {
    ...
    private class ImageLoader extends AsyncTask<Object, String, Bitmap> {
        ...
        protected Bitmap doInBackground(Object... parameters) {
            ...
            Bitmap curThumb = MediaStore.Video.Thumbnails.getThumbnail(VideoAdapter.this.mContext.getContentResolver(), id, MediaStore.Video.Thumbnails.MINI_KIND, options);
